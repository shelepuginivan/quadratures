...
typedef enum {
    ...
    QUAD_NC_CLOSED_METHOD_SIMPSON = 2,
    QUAD_NC_CLOSED_METHOD_SIMPSON_3_8 = 3,
    QUAD_NC_CLOSED_METHOD_BOOLE = 4,
    QUAD_NC_CLOSED_METHOD_N_5 = 5,
    QUAD_NC_CLOSED_METHOD_WEDDLE = 6,

    QUAD_NC_CLOSED_METHOD_ENTRY_NUMBER,
} QuadNCClosedMethod;
